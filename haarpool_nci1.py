...
Original file is located at
    https://colab.research.google.com/drive/1WJd4fMgY4zQTSFH_xkTLLdcaewL9sQSm
...
print('- patience for early stopping: ',early_stopping)
print('Datasets')
#print('- name: ',dataname)
...
class Net(torch.nn.Module):
    def __init__(self):
        ...
        self.lin2 = torch.nn.Linear(4*self.nhid, 8*self.nhid)
        self.lin3 = torch.nn.Linear(8*self.nhid, num_classes)  
